 ...
 *
 * Work is handed down, never taken. Associates and above assign; analysts read
 * what they have been given and cannot assign at all, including to themselves.
 * The first version let an analyst pick up unclaimed work, which put the choice
 * of what to work on below the person accountable for it — withdrawn on
 * 2026-09-08.
 */
...
/** Assign a task to somebody on this project. Associate and above. */
router.post(
  "/projects/:projectId/task-assignments",
  ...
  async (req, res): Promise<void> => {
    ...
    // Omitting the assignee means "me" — an associate taking a task rather
    // than handing it on.
    const uid =
...
/** Withdraw an assignment. Associate and above, matching the assigning. */
router.delete(
